...
variable {m : Type u → Type v} {n : Type u → Type w}
  [Monad m] [Monad n] [MonadLiftT m n] [LawfulMonadLiftT m n]
  {α β γ : Type u}
...
variable {m : Type u → Type v} [Monad m] [LawfulMonad m] {σ : Type u}
...
variable {m : Type u → Type v} [Monad m] {ρ : Type u}
...
variable {m : Type u → Type v} [Monad m] [LawfulMonad m] {α β : Type u}
...
variable {m : Type u → Type v} [Monad m] [LawfulMonad m] {ε α β : Type u}
